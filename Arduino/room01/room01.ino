/* Decription: The following MQTT example is a representation of the a room with
 *  the following sensors: Light, window and door. The sensors status are sending
 *  periodically to the mqtt client.
